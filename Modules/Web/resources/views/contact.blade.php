                        ...
                        <div class="space-y-6">
                            ...
                            @if($vendor)
                                <div class="pt-6 flex gap-4">
                                    ...
                                    @endif
                                    @if($vendor->instagram)
                                        <a href="{{ $vendor->instagram }}" target="_blank" class="w-10 h-10 rounded-full bg-rose-50 flex items-center justify-center text-primary hover:bg-rose-100 transition-all">

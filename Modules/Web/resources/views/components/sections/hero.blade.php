...
@if($slides && $slides->count() > 0)
    <div class="relative min-h-[90vh] pt-20">
        <div class="swiper hero-swiper h-[80vh]">
            <div class="swiper-wrapper">
                @foreach($slides as $slide)
                    <div class="swiper-slide relative flex items-center overflow-hidden bg-gray-900 rounded-[3rem] mx-4 sm:mx-8">
                            ...
                            <div class="max-w-2xl">
                                ...
                                @if($slide->link)
                                    <div class="flex items-center gap-6">
                                        <a href="{{ $slide->link }}" class="px-10 py-5 bg-primary text-white rounded-2xl font-bold text-lg hover:opacity-90 transition-all shadow-xl shadow-primary/20 flex items-center gap-3">

...
<x-web::layouts.master>
    <div class="bg-bg-soft min-h-screen pb-20">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
            <div class="bg-white rounded-3xl shadow-2xl shadow-primary/10 p-8 border border-rose-50">
                <form action="{{ route('web.promotions.index', ['vendor_id' => request('vendor_id')]) }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" name="search" value="{{ request('search') }}" 
                                   ...
                                   class="w-full bg-rose-50/50 border-2 border-transparent focus:border-primary/20 rounded-2xl px-6 py-4 outline-none transition-all font-medium text-gray-700">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="type" onchange="this.form.submit()" 
                                class="w-full bg-rose-50/50 border-2 border-transparent focus:border-primary/20 rounded-2xl px-6 py-4 outline-none transition-all font-medium text-gray-700 appearance-none cursor-pointer">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($promotions as $promotion)
                        <a href="{{ route('web.promotions.show', ['id' => $promotion->id, 'vendor_id' => request('vendor_id')]) }}" 
                           class="group bg-white rounded-[2.5rem] overflow-hidden border border-rose-50 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-500 hover:-translate-y-2">

            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2 p-6 bg-slate-50 rounded-2xl border border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="setup_fee" value="{{ old('setup_fee', 0) }}" class="w-full px-6 py-4 bg-white border border-gray-100 rounded-2xl focus:ring-4 focus:ring-primary/10 outline-none transition-all font-bold text-gray-900" placeholder="0.00">
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-gray-50 pt-8">
                    ...
                    <div>
                        ...
                        <input type="date" name="contract_signed_at" value="{{ old('contract_signed_at') }}" class="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium">
                    </div>
                </div>

            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-gray-50/50">
                        <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center w-16">#</th>
                        <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">{{ __('Logo') }}</th>
                        <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">{{ __('Name') }}</th>
                        <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">{{ __('Status') }}</th>
                        <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">{{ __('QR Code') }}</th>
                        ...
                        <td class="px-8 py-6 text-center">
                            <div class="flex justify-center gap-2">
                                <div class="group relative">
                                    <a href="{{ route('home', ['vendor_id' => $vendor->slug]) }}" target="_blank" class="p-2 text-gray-400 hover:text-primary transition-colors block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                        </svg>
                                    </a>
                                    <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-gray-900 text-white text-[10px] font-bold rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50">
                                        {{ __('View Store') }}
                                ...
                                <div class="group relative">
                                    <a href="{{ route('admin.products.index', ['vendor_id' => $vendor->id]) }}" class="p-2 text-gray-400 hover:text-blue-500 transition-colors block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="group relative">
                                    <a href="{{ route('admin.regions.index', ['vendor_id' => $vendor->id]) }}" class="p-2 text-gray-400 hover:text-green-500 transition-colors block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="group relative">
                                    <a href="{{ route('admin.vendors.contract', $vendor) }}" class="p-2 text-gray-400 hover:text-yasmina-500 transition-colors block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="group relative">
                                    <a href="{{ route('admin.vendors.edit', $vendor) }}" class="p-2 text-gray-400 hover:text-primary transition-colors block">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="group relative">
                                    ...
                                    <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-red-600 text-white text-[10px] font-bold rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-50 shadow-lg">
                                        {{ __('Delete') }}

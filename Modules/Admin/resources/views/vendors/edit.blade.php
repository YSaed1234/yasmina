            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-gray-50 pt-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="manager_name" value="{{ old('manager_name', $vendor->manager_name) }}" class="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">{{ __('Manager National ID') }}</label>
                        <input type="text" name="manager_id_number" value="{{ old('manager_id_number', $vendor->manager_id_number) }}" class="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium">
                    </div>
                    <div>

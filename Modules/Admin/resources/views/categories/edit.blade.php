    ...
    <div class="max-w-2xl bg-white/70 backdrop-blur-md p-8 rounded-3xl border border-rose-50 shadow-xl shadow-rose-100/50">
        <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" class="w-full px-5 py-4 bg-rose-50/50 border border-rose-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-rose-100 focus:border-rose-300 transition-all outline-none font-bold text-gray-700" value="{{ $category->name }}" required>
            ...
            <div>
                ...
                <input type="number" name="rank" id="rank" class="w-full px-5 py-4 bg-rose-50/50 border border-rose-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-rose-100 focus:border-rose-300 transition-all outline-none font-bold text-gray-700" value="{{ $category->rank }}">

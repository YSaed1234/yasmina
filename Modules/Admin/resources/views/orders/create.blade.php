<x-admin::layouts.master>
    <div class="mb-10">
        <a href="{{ route('admin.orders.index') }}" class="text-primary font-bold text-sm flex items-center gap-2 mb-4 hover:gap-3 transition-all">
    ...
    <form action="{{ route('admin.orders.store') }}" method="POST" id="manualOrderForm">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">{{ __('Vendor') }}</label>
                            <select name="vendor_id" id="vendor_id" required class="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium">
                        ...
                        @else
                            <input type="hidden" name="vendor_id" id="vendor_id" value="{{ auth()->user()->vendor_id }}">
                        @endif

                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">{{ __('Order Source') }}</label>

    ...
    <div class="bg-white/70 backdrop-blur-md rounded-3xl border border-yasmina-50 shadow-xl shadow-yasmina-100/50 overflow-hidden">
        <table class="min-w-full divide-y divide-yasmina-50">
            <thead class="bg-yasmina-50/50">
                <tr>
                    <th class="px-6 py-4 text-left text-xs font-bold text-yasmina-500 uppercase tracking-widest">{{ __('Role Name') }}</th>
                    <th class="px-6 py-4 text-left text-xs font-bold text-yasmina-500 uppercase tracking-widest">{{ __('Permissions') }}</th>
                    <th class="px-6 py-4 text-right text-xs font-bold text-yasmina-500 uppercase tracking-widest">{{ __('Actions') }}</th>
                </tr>
            </thead>

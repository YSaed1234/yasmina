        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="price" value="{{ old('price') }}" class="w-full px-5 py-4 bg-yasmina-50/50 border {{ $errors->has('price') ? 'border-red-500' : 'border-yasmina-100' }} rounded-2xl focus:bg-white focus:ring-4 focus:ring-yasmina-100 focus:border-yasmina-300 transition-all outline-none font-bold text-gray-700" placeholder="0.00" required>
                    @error('price')
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="discount_price" value="{{ old('discount_price') }}" class="w-full px-5 py-4 bg-yasmina-50/50 border {{ $errors->has('discount_price') ? 'border-red-500' : 'border-yasmina-100' }} rounded-2xl focus:bg-white focus:ring-4 focus:ring-yasmina-100 focus:border-yasmina-300 transition-all outline-none font-bold text-gray-700" placeholder="0.00">
                ...
                <div class="p-6 bg-amber-50/50 rounded-3xl border border-amber-100 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="flash_sale_price" value="{{ old('flash_sale_price') }}" class="w-full px-5 py-4 bg-white border {{ $errors->has('flash_sale_price') ? 'border-red-500' : 'border-amber-100' }} rounded-2xl focus:ring-4 focus:ring-amber-100 outline-none font-bold text-gray-700" placeholder="0.00">
                ...
                <div class="p-6 bg-yasmina-50/50 rounded-3xl border border-yasmina-100 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="is_gift" id="is_gift" value="1" class="w-5 h-5 text-yasmina-500 border-yasmina-100 rounded focus:ring-yasmina-500">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="gift_threshold" class="w-full px-5 py-4 bg-white border border-yasmina-100 rounded-2xl focus:ring-4 focus:ring-yasmina-100 outline-none font-bold text-gray-700" placeholder="0.00">
                    </div>
                </div>

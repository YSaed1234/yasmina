                                ...
                                <tbody id="variants-body">
                                    @foreach($product->variants as $index => $variant)
                                        <tr class="bg-white rounded-xl shadow-sm border border-yasmina-50 group">
                                            ...
                                            <td class="px-4 py-3">
                                                <input type="text" name="variants[{{ $index }}][color]" value="{{ $variant->color }}" class="w-full px-3 py-2 bg-yasmina-50/50 border border-transparent rounded-lg focus:bg-white focus:border-yasmina-300 outline-none text-xs font-bold transition-all" placeholder="{{ __('Red, Blue...') }}">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input type="text" name="variants[{{ $index }}][size]" value="{{ $variant->size }}" class="w-full px-3 py-2 bg-yasmina-50/50 border border-transparent rounded-lg focus:bg-white focus:border-yasmina-300 outline-none text-xs font-bold transition-all" placeholder="{{ __('XL, 42...') }}">
                                            </td>
                                            <td class="px-4 py-3">
                                                @if($variant->image)
                                                    <div class="mb-1">
                                                ...
                                                @endif
                                                <input type="file" name="variants[{{ $index }}][image]" class="w-full text-[10px] file:mr-2 file:py-1 file:px-2 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-yasmina-50 file:text-yasmina-700 hover:file:bg-yasmina-100">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input type="number" step="0.01" name="variants[{{ $index }}][price]" value="{{ $variant->price }}" class="w-full px-3 py-2 bg-yasmina-50/50 border border-transparent rounded-lg focus:bg-white focus:border-yasmina-300 outline-none text-xs font-bold transition-all" placeholder="0.00">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input type="number" name="variants[{{ $index }}][stock]" value="{{ $variant->stock }}" class="w-full px-3 py-2 bg-yasmina-50/50 border border-transparent rounded-lg focus:bg-white focus:border-yasmina-300 outline-none text-xs font-bold transition-all" placeholder="0">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input type="text" name="variants[{{ $index }}][sku]" value="{{ $variant->sku }}" class="w-full px-3 py-2 bg-yasmina-50/50 border border-transparent rounded-lg focus:bg-white focus:border-yasmina-300 outline-none text-xs font-bold transition-all" placeholder="SKU-123">
                                            </td>
                    ...
                    function addVariant() {
                        ...
                        const row = `
                            <tr class="bg-white rounded-xl shadow-sm border border-yasmina-50 group">
                                ...
                                <td class="px-4 py-3">
                                    <input type="file" name="variants[${variantIndex}][image]" class="w-full text-[10px] file:mr-2 file:py-1 file:px-2 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-yasmina-50 file:text-yasmina-700 hover:file:bg-yasmina-100">
                                </td>
                                <td class="px-4 py-3">

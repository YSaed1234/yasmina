<x-vendor::layouts.master>
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            ...
            <p class="text-gray-500 mt-2">{{ __('Monitor your stock levels for all your products.') }}</p>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-yasmina-50/30 transition-all">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="{{ route('vendor.products.edit', $product['id']) }}" class="p-2 bg-yasmina-50 text-yasmina-600 rounded-xl hover:bg-primary hover:text-white transition-all shadow-sm" title="{{ __('Edit Product') }}">

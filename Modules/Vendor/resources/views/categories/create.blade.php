<x-vendor::layouts.master>
    <div class="mb-10">
        <h1 class="text-3xl font-bold text-gray-800">{{ __('Add New Category') }}</h1>
    ...
    <div class="max-w-2xl bg-white/70 backdrop-blur-md p-10 rounded-[3rem] border border-gray-100 shadow-xl shadow-gray-100/50">
        <form action="{{ route('vendor.categories.store') }}" method="POST" class="space-y-8">
            @csrf

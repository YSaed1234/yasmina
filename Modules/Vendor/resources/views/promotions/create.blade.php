...
<div class="p-8 max-w-5xl" x-data="{ type: 'bogo_same', discountType: 'free' }">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">{{ __('Create New Deal') }}</h1>
            <p class="text-gray-500 mt-1">{{ __('Define your promotional rules and BOGO offers.') }}</p>
        </div>
    </div>

    <form action="{{ route('vendor.promotions.store') }}" method="POST" class="space-y-8">
        @csrf
        ...
        <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-yasmina-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    <input type="text" name="name_ar" class="w-full px-6 py-4 bg-yasmina-50/50 border-0 rounded-2xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900" placeholder="{{ __('e.g. عرض اشترِ 2 واحصل على 1 مجاناً') }}">
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-black text-gray-700 uppercase tracking-widest">{{ __('Deal Name (English)') }}</label>
                    <input type="text" name="name_en" class="w-full px-6 py-4 bg-yasmina-50/50 border-0 rounded-2xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900" placeholder="{{ __('e.g. Buy 2 Get 1 Free') }}">
                </div>
            </div>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4 mt-4">
                            <div class="flex-1">
                                ...
                                <input type="number" name="buy_quantity" value="1" min="1" class="w-full px-6 py-3 bg-yasmina-50/50 border-0 rounded-xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4" x-show="type === 'bogo_different'">
                        ...
                        <div class="flex items-center gap-4 mt-4">
                            <div class="flex-1">
                                ...
                                <input type="number" name="get_quantity" value="1" min="1" class="w-full px-6 py-3 bg-yasmina-50/50 border-0 rounded-xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900">
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-yasmina-50">
            ...
            <div class="space-y-4" x-show="discountType !== 'free'">
                ...
                <div class="relative">
                    <input type="number" name="discount_value" value="0" step="0.01" class="w-full px-6 py-4 bg-yasmina-50/50 border-0 rounded-2xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900">
                ...
                <p class="text-xs text-gray-400 font-medium" x-show="discountType === 'percentage'">
                    {{ __('e.g. Enter 50 for 50% discount on the "Get Product".') }}
                </p>
            </div>
        ...
        <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-yasmina-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div class="space-y-2">
                    ...
                    <input type="date" name="starts_at" class="w-full px-6 py-4 bg-yasmina-50/50 border-0 rounded-2xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900">
                </div>
                <div class="space-y-2">
                    <label class="text-sm font-black text-gray-700 uppercase tracking-widest">{{ __('Expires At') }}</label>
                    <input type="date" name="expires_at" class="w-full px-6 py-4 bg-yasmina-50/50 border-0 rounded-2xl focus:ring-2 focus:ring-yasmina-500 font-bold text-gray-900">
                </div>
            </div>
            <label class="flex items-center gap-4 p-6 bg-yasmina-50/50 rounded-3xl cursor-pointer">
                <input type="checkbox" name="is_active" value="1" checked class="w-6 h-6 rounded-lg text-yasmina-600 focus:ring-yasmina-500 border-0">
                <div>
